...
class IssuesTests: XCTestCase {
    ...
    func testDecodedPalleasOpensourceIssues() {
        ...
        let shipItMilestone = Milestone(ID: "1881390", number: 1, state: .Open, title: "Release this app", contentDescription: "That'd be cool", creator: palleasOpensource, numberOfOpenIssues: 1, numberOfClosedIssues: 0, createdAt: NSDateFormatter.ISO8601.dateFromString("2016-07-13T16:56:48Z")!, updatedAt: NSDateFormatter.ISO8601.dateFromString("2016-07-13T16:56:57Z")!, closedAt: nil, dueOn: NSDateFormatter.ISO8601.dateFromString("2016-07-25T04:00:00Z")!, URL: NSURL(string: "https://api.github.com/repos/Palleas-opensource/Sample-repository/milestones/1")!)

        let updateReadmePullRequest = PullRequest(URL: NSURL(string: "https://github.com/Palleas-opensource/Sample-repository/pull/3")!, diffURL: NSURL(string: "https://github.com/Palleas-opensource/Sample-repository/pull/3.diff")!, patchURL: NSURL(string: "https://github.com/Palleas-opensource/Sample-repository/pull/3.patch")!)
        ...
        let expected = [
            ...
            Issue(id: 156633109,
                ...
                user: palleasOpensource,
                labels: [Label(name: "bug", color: SWColor(hexString: "ee0701")!),
                    Label(name: "duplicate", color: SWColor(hexString: "cccccc")!),
                    Label(name: "enhancement", color: SWColor(hexString: "84b6eb")!)],
