...
class ContentTests: XCTestCase {
    ...
    func testDecodedDirectory() {
        let expected: Content = .directory([
            ...
            Content.File(
                ...
                downloadURL: URL(string: "https://raw.githubusercontent.com/mdiep/Tentacle/master/update-test-fixtures/main.swift")
            )
        ])
    ...
    func testDecodedSymlink() {
        let expected: Content = .file(Content.File(
            ...
            downloadURL: URL(string: "https://raw.githubusercontent.com/Palleas-opensource/Sample-repository/master/say")
        ))
